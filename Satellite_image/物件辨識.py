...
PATH_train = "/content/train/data"

# 定義類別名稱到數字標識的映射
class_mapping = {0: "cloudy", 1: "water", 2: "desert", 3: "green_area"}

# 加載訓練資料集
train_data = datasets.ImageFolder(PATH_train, transform=transforms)

# 將標籤重新映射為數字標識
train_data.targets = [class_mapping[label] for label in train_data.targets]
...
print(device)
PATH_train = R"/content/train/data"
